...
namespace Android.Views
{
    ...
    public class SearchView : MvxAppCompatActivity<SearchViewModel>
    {
        ...
        private void BindResources()
        {
            ...
            var addFavouriteButton = FindViewById<Button>(Resource.Id.addFavouriteButton);
            addFavouriteButton.Text = AppResources.AddFavouriteButton;

            ViewModel.CityName = Xamarin.Essentials.Preferences.Get("CityName", string.Empty);
